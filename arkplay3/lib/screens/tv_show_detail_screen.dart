...
class _TVShowDetailScreenState extends State<TVShowDetailScreen> {
  ...
  void _updateServerUrls(Episode episode) {
    ...
    final urls = [
      ...
      'https://vidsrc.xyz/embed/tv?tmdb=$tvShowId&season=$seasonNumber&episode=$episodeNumber',
      'https://multiembed.mov/directstream.php?video_id=$tvShowId&tmdb=1&s=$seasonNumber&e=$episodeNumber',
      'https://multiembed.mov/?video_id=$tvShowId&tmdb=1&s=$seasonNumber&e=$episodeNumber',
      'https://moviesapi.club/tv/$tvShowId-$seasonNumber-$episodeNumber'
    ];
    setState(() {
      _serverUrls = urls;
    });
  ...
  void _openPlayer() {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => VideoPlayerScreen(serverUrls: _serverUrls),
      ),
    );
  }
